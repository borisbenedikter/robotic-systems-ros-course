...
class WallDetector(Node):
    ...
    def turtle_pose_callback(self, msg):
        ...
        self.turtle_x = msg.position.x
        self.turtle_y = msg.position.y
        # turtle_quaternion = msg.orientation
        # turtle_q1 = turtle_quaternion.x
        # turtle_q2 = turtle_quaternion.y
        # turtle_q3 = turtle_quaternion.z
        # turtle_q4 = turtle_quaternion.w
